...
// export function SearchBtn({ setIsSearchActive }) {
//     console.log('setIsSearchActive in SearchBtn:', typeof setIsSearchActive);
//     return (
//         <button className="search-btn" onClick={() => setIsSearchActive(true)}>
//             <section className="search-icon">
